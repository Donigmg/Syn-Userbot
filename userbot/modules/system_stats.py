...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Syn-Userbot](https://github.com/xsyn1100/Syn-Userbot) is Up and Running.**\n\n"
        f"**{alive_text}**\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/synxsupport)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/synxupate)** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={user.id})**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
